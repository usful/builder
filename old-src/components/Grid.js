...
const styles = {
  container: {
    ...
    backgroundImage:
      'linear-gradient(rgba(255,255,255,0.5) 2px, transparent 2px), linear-gradient(90deg, rgba(255,255,255,0.5) 2px, transparent 2px), linear-gradient(rgba(255,255,255,0.66) 1px, transparent 1px), linear-gradient(90deg, rgba(255,255,255,0.66) 1px, transparent 1px)',
    zIndex: 0,
...
export default class Grid extends Component {
  ...
  componentWillMount() {
    ...
    this.selectedBlockContainerSetListener = AppState.addListener(
